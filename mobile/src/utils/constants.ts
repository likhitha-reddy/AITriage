...
export const MENTAL_HEALTH_HELPLINES = [
  ...
  {label: 'Emergency services', value: 'Call your local emergency number immediately'},
  {label: 'Trusted person', value: 'Reach out to a family member, friend, or clinician now'},
];
